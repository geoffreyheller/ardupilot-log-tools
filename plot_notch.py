...
"""Notch verification chart: pre/post-filter spectra plus notch tracking.
    ...
    ./plot_notch.py "flight.bin" -o notch-verification-2026-09-04.png
...
from dflog import Log, airborne_window, esc_fundamental        # noqa: E402
from dflog.analysis import check_batch_fft                     # noqa: E402
...
def main():
    ...
    ap.add_argument("--window", default="rpm",
                    choices=["auto", "ev", "rpm", "throttle", "arm"])
